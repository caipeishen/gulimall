...
CREATE TABLE `ums_member`  (
  ...
  `social_uid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '微博社交用户唯一ID',
  `access_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问令牌',
  `expires_in` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问令牌时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `ums_member` VALUES (1, 1, 'Ferris', '$2a$10$CghjjlJuGiellrRrZtn0x.dZ6La0yUMcHmQU.u1rk5ZLuIyRu/APm', 'Cai Peishen', '18848848551', 'xxx@foxmail.com', NULL, 1, '2021-03-09', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2021-03-09 23:01:13', NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (6, 1, 'Cai Peishen', '$2a$10$CghjjlJuGiellrRrZtn0x.dZ6La0yUMcHmQU.u1rk5ZLuIyRu/APm', NULL, NULL, NULL, NULL, NULL, '2021-03-10', NULL, NULL, NULL, NULL, NULL, NULL, 0, '2021-03-10 22:11:58', '7340640994', '2.005DamAIw_4wSE494ff94714Pn68BD', '157679999');
...
INSERT INTO `ums_member_level` VALUES (2, '铜牌会员', 0, 0, 279.0000, 30, 0, 1, 1, '铜牌会员');
INSERT INTO `ums_member_level` VALUES (3, '银牌会员', 0, 0, 229.0000, 50, 0, 1, 1, '银牌会员');
...
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES (1, 1, 'Ferris', '18848848551', NULL, '上海市', '上海市', '长宁区', '古北财富中心2期', NULL, 1);
