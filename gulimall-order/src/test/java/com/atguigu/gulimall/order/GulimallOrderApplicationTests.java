...
class GulimallOrderApplicationTests {
    ...
    void createExchange() {
        ...
        DirectExchange exchange = new DirectExchange(MyRabbitConfig.exchange, true, false);
    ...
    void createQueue() {
        ...
        Queue queue = new Queue(MyRabbitConfig.queue, true, false, false);
    ...
    void createBinding() {
        ...
        Binding binding = new Binding(MyRabbitConfig.queue,
                Binding.DestinationType.QUEUE,
                MyRabbitConfig.exchange,
                MyRabbitConfig.routingKey,
                null);
        this.amqpAdmin.declareBinding(binding);
        log.info("Binding [" + "hello-java-binding-routingKey" + "] 创建成功");
    }
