...
import com.atguigu.common.consant.ProductConstant;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void saveSpuInfo(SpuSaveVo vo) {
        ...
        this.imagesService.saveImages(infoEntity.getId(),images);
        ...
        this.attrValueService.saveProductAttr(collect);
        ...
        if(skus!=null && skus.size()>0){
            skus.forEach(item->{
                ...
                if(skuReductionTo.getFullCount() >0 || skuReductionTo.getFullPrice().compareTo(new BigDecimal("0")) == 1){
                    R r1 = this.couponFeignService.saveSkuReduction(skuReductionTo);
                    if(r1.getCode() != 0){
    ...
    public void up(Long spuId) {
        ...
        // 可检索的id集合
        Set<Long> isSet = new HashSet<Long>(attrService.selectSearchAttrIds(attrIds));
    ...
    public SpuInfoEntity getSpuInfoBySkuId(Long skuId) {
        return super.getById(this.skuInfoService.getById(skuId).getSpuId());
    }
